...
int main () {
    ...
    while (cin >> sequencia) {
        if ((caracter1 == ':' and caracter2 == '-' and sequencia == ')') or (caracter1 == '(' and caracter2 == '-' and sequencia == ':')) ++contador_feliz;
        if ((caracter1 == ':' and caracter2 == '-' and sequencia == '(') or (caracter1 == ')' and caracter2 == '-' and sequencia == ':')) ++contador_triste;
